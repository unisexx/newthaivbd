...
<!-- PAGE CONTENT BEGINS HERE -->
    <form id="validation-form" class="form-horizontal" method="post" action="docs/admin/docs/save/<?php echo $project->id?>?module=<?php echo $_GET['module']?>" enctype="multipart/form-data">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="form-field-8" class="input-xxlarge" name="image" value="<?php echo $project->image?>"> <input class="btn btn-mini btn-info" type="button" name="browse" value="เลือกรูปภาพ" onclick="browser($(this).prev(),'file')" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="input-xxlarge" rows="5" id="form-field-9" name="detail"><?php echo $project->detail?></textarea>
            </div>
        </div>
