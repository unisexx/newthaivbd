...
function openKCFinder(field_name, url, type, win) {
    tinyMCE.activeEditor.windowManager.open({
        file: '/newthaivbd/media/kcfinder/browse.php?opener=tinymce&type=' + type+ '&dir=' + type + '/public',
        title: 'File Manager',
        width: 700,
        height: 500,
        resizable: "yes",
...
function browser(element,type) {
    ...
    window.open('/newthaivbd/media/kcfinder/browse.php?type='+type+'&dir='+type+'/public',
